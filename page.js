          ...
          <div style={{ background: '#111620', border: '1px solid rgba(255,255,255,0.07)', margin: '0 12px 16px', borderRadius: '16px', overflow: 'hidden' }}>
            ...
            <div style={{ display: 'flex', padding: '8px 10px 10px', borderTop: '1px solid rgba(255,255,255,0.04)', gap: '4px' }}>
              <button onClick={handleLikePost}
                style={{ display: 'flex', alignItems: 'center', gap: '5px', padding: '8px 14px', border: 'none', background: liked ? 'rgba(255,69,96,0.1)' : 'rgba(255,255,255,0.04)', borderRadius: '10px', cursor: 'pointer', color: liked ? '#ff4560' : '#4a5568', fontSize: '13px', fontWeight: '600', transition: 'all 0.2s' }}>
              ...
              {post.media_type === 'video' && (
                <button onClick={() => window.location.href = '/echo'}
                  style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '4px', padding: '8px 12px', border: 'none', background: 'rgba(255,165,0,0.1)', borderRadius: '10px', cursor: 'pointer', color: '#ffa500', fontSize: '12px', fontWeight: '600' }}>
                  ⚡ ECHO
                </button>
              )}
            </div>
        ...
        <div style={{ padding: '0 12px' }}>
          ...
          {comments.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '40px 20px', color: '#4a5568' }}>
              ...
              <div style={{ fontSize: '14px', marginBottom: '4px', color: '#8892a4' }}>No comments yet</div>
              <div style={{ fontSize: '12px' }}>Be the first to comment!</div>
            </div>
          ) : (
