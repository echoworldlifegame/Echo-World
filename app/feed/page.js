      ...
      <div style={{ position: 'fixed', top: 0, left: 0, right: 0, background: 'rgba(7,10,16,0.97)', borderBottom: '1px solid rgba(255,255,255,0.07)', zIndex: 100 }}>
        <div style={{ padding: '0 12px', height: '54px', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <div style={{ position: 'relative', flexShrink: 0 }}>
            ...
            {dmCount > 0 && (
              <div style={{ position: 'absolute', top: '-3px', right: '-3px', background: '#00e5ff', borderRadius: '50%', width: '15px', height: '15px', fontSize: '8px', fontWeight: '700', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#070a10' }}>
                {dmCount > 9 ? '9+' : dmCount}
              </div>
            )}
          </div>
